  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className=" h-[10rem] w-[32rem] bg-primary rounded-2xl p-2 relative"
      > 
        <div
          style={{
            boxShadow: " 0px 2px 0px 2px var(--neutral-900) inset ",
          }}
          className="absolute border border-t-4 inset-0 bg-[#010101] rounded-lg flex items-center justify-center"

        >
            <div className="absolute inset-2 bg-gradient-to-r from-slate-700 to-slate-700 via-gray-400 rounded-sm ">
