  ...
  return (
    <Card className="w-[350px] rounded-3xl bg-zinc-800 ">
      <CardHeader>
        ...
        <CardDescription className="text font-Enterpriser bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-red-600">1 ZCR = $0.001 <br />Next Stage Price = $ 0.002</CardDescription>
        <Progress value={78} />
        ...
        <form>
          <div className="grid w-full items-center gap-4 ">
            ...
            <div className="flex flex-col space-y-3 "> 
              ...
              <Label htmlFor="framework" className="text-s font-Enterpriser bg-clip-text text-transparent bg-gradient-to-r from-white to-red-600">Amount in ZCR You Receive</Label>
